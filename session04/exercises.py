...
a = 3
a + 2
print('This output is an integer:', a + 2)

a = a + 1.0
a
print('This output is floating-point addition:', a)

a = 3
b = a 
b
print('This output is an integer:', b)

a = 3
a == 5.0
a
print('This output is an integer:', a)

b = 10
c = b > 9
c
print('This output is boolean:', c)

5 / 2 == 5 / 2.0
print('This output is boolean:', 5 / 2 == 5 / 2.0)
...
print('This output is a Boolean \'False\':', 3.0 - 1.0 != 5.0 - 3.0)
print('This output is a Boolean \'False\':', 3 > 4 or (2 < 3 and 9 > 10))
print('This output is a Boolean \'False\':', 4 > 5 or 3 < 4 and 9 > 10)
print('This output is a Boolean \'False\':', not(4 > 3 and 100 > 6))
